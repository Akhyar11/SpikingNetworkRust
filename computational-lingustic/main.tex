...
\runningtitle{Inefficiency of Spike-Overlap Attention}
\runningauthor{Akhyar}

\begin{document}

\title{Is Spike-Driven Self-Attention Necessary? The Inefficiency\\ of Spike-Overlap Attention in Spiking\\ Sentence Embeddings}

\author{Muhammad Akhyar\thanks{Corresponding author}}

\affilblock{
    \affil{Independent Researcher\\\quad \email{akhyarsafrudin@gmail.com}}
}
...
\begin{itemize}
    \item \textbf{Base Model} (\url{https://huggingface.co/PulseNet-Labs/spiking-sentence-embedder-v2}): Achieves the reported $r = 0.8030$ Pearson correlation on the STS benchmarks.
    \item \textbf{Multilingual Model} (\url{https://huggingface.co/PulseNet-Labs/spiking-sentence-embedder-multilingual-v1}): Extends the vocabulary to $64,000$ to support cross-lingual semantic search across 20+ languages.
\end{itemize}
