...
The review process can be summarized in the following four phases:
    ...
    Decision. The discussion period ends when the action editor enters a decision for the paper, which is one of the following:
...
Finally, other certifications are added to publications based on specialized processes:
    ...
    Expert Certification. Awarded to papers that are authored by highly-rated TMLR reviewers (i.e. our Expert Reviewers), to recognize their contributions and expertise.

Authorship quotas

Authors are restricted in the number of submissions they can make per year, according to the Generalized Harmonic Quota Rule, with parameters N_1 = 2 and N_9 = 9. While this is a bit difficult to interpret, an author starts each year with a certain budget, and some budget is spent per submission they make to TMLR, where the amount spent depends on the number of authors on the submission. Authors can check how much of their budget remains by using this tool. All authors must have sufficient budget remaining for the year in order to make a submission. It is the responsibility of the authors to ensure that all authors have sufficient budget remaining. Budget is spent for all submissions by an author, including those which are desk rejected.
Open access policy
...
Individuals should be listed as authors on a TMLR submission if and only if they satisfy all of the following criteria:

    They have made a substantial intellectual contribution to the work described in the submission. This may include, but is not limited to: conception, design, or analysis of the work.
    They have contributed to drafting or revising the submission.
    They take full responsibility for all content in the final published work.

Furthermore, individuals listed as authors on a TMLR submission testify that:

    They are aware the submission has been submitted to TMLR.
    They agree to be held responsible and accountable for issues related to correctness or integrity of the work.
    To the best of their knowledge, the work submitted is original, all individuals who satisfy the authorship criteria outlined above are listed as authors, and the submission is an honest representation of the underlying work.
...
TMLR gives no prescription on how to order authors, and this may be decided by the authors themselves in accordance with the customs of the subcommunity the work contributes to (e.g., alphabetically, in order of contribution, etc.). Authors may choose to include a statement indicating author contributions.

Some parts of this policy are adapted from similar policies of ACM and IEEE.
Ethical publishing
...
To handle an allegation or discovery of misconduct, TMLR follows the Committee on Publishing Ethics’s (COPE) guidelines listed below. According to these guidelines, a determination of misconduct may result in TMLR contacting the author institutions, funding agencies, and/or potential victims. At the discretion of the Editors-in-Chief, additional actions may be taken, including issuing an informal or formal warning to the offender and barring them from submitting a manuscript to TMLR for a fixed duration.

Intellectual property, including plagiarism or redundant (duplicate) publication:

    COPE Council. Suspected plagiarism in a submitted manuscript.
    COPE Council. Suspected plagiarism in a published manuscript.
    COPE Council. Suspected redundant publication in a submitted manuscript.
    COPE Council. Suspected redundant publication in a published manuscript.

Research Fraud:

    COPE Council. Suspected fabricated data in a submitted manuscript.
    COPE Council. Suspected fabricated data in a published manuscript.

Reviewer or editor misconduct during the review process:  

    COPE Council. Reviewer suspected to have appropriated an author’s ideas or data.

After a paper is accepted and the Action Editor approves the camera-ready version, this version is considered final and the paper is published. Under exceptional circumstances, the authors may wish to revise the camera-ready version of the paper -- requests of this nature should be directed to the Editors in Chief, describing the nature of the revision and the reasons why this revision was not performed prior to publication.

By default, TMLR follows COPE guidelines (e.g., for adding or removing authors, or retracting a paper). In the event that TMLR retracts a publication because evidence shows that the findings are unreliable, either because of misconduct or honest error, or that the findings have been plagiarized or previously published, or that the research is unethical), a Notice of Retraction will be attached to the paper on OpenReview.

In the case of post-publication edits or corrections to the paper, the EiCs may involve the paper's Action Editor to judge the proposed edits, including their correctness and/or appropriateness (checking, e.g., if the paper instead ought be retracted, or if the changes should be included in a separate and subsequent publication). Any significant changes should be documented in a section at the end of the paper (subsequent to any Acknowledgments, prior to References) titled "Post-Publication Changes." In all cases of modifications to published papers or retractions, the paper's full revision history will remain visible on OpenReview, and the Editors in Chief will post a public comment on the OpenReview page upon update indicating the nature of any changes made to the paper.