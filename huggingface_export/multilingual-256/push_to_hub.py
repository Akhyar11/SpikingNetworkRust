...
def push_model():
    ...
    # ---------------------------------------------------------
    repo_id = "PulseNet-Labs/spiking-sentence-embedder-multilingual-v1"
    ...
    # 5. Unggah README.md (Model Card)
    if os.path.exists("README.md"):
        print("- Mengunggah README.md (Model Card)...")
        api.upload_file(
            path_or_fileobj="README.md",
            path_in_repo="README.md",
            repo_id=repo_id,
        )
        print("  README.md berhasil diunggah!")
