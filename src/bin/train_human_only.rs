...
fn main() {
    ...
    let file = File::open(dataset_path).expect("Gagal membuka dataset. Pastikan Anda sudah menjalankan create_human_only_dataset.js");
    ...
    println!("\nTraining Murni STS-B Manusia selesai! Model tersimpan di {}", model_save_path);
}
