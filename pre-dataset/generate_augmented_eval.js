...
console.log("Membaca dataset evaluasi...");
const data = require('./dataset_20_bahasa_eval.json');
...
console.log("Memproses tiap bahasa untuk evaluasi...");
...
console.log(`Total dataset evaluasi baru: ${finalDataset.length} pasang kalimat.`);
const outputFile = './dataset_augmented_eval_1000.json';
fs.writeFileSync(outputFile, JSON.stringify(finalDataset, null, 2), 'utf-8');
console.log(`Dataset evaluasi berhasil disimpan ke ${outputFile}`);
