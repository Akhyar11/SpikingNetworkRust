...
The Recurrent Pooler achieves highly competitive performance across all subsets, occasionally surpassing the Jaccard Attention (e.g., STS-12, STS-13, STS-14), confirming that explicit spike-driven self-attention is largely unnecessary for general semantic embedding tasks.
